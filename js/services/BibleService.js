...
function initializeBibleLocalStorage(){
    window.localStorage.setItem(
        ...
        {   "iso": "ar",
            ...
            "download_book": "٪ جاهزة للاستخدام دون اتصال",
            "downloading": "جارى التحميل",
            "downloading_chapter": "تحميل الفصل",
            "link_to_app": ": هذا هو الرابط لتطبيق إبداعات جديدة",
        ...
        {   "iso": "fa",
            ...
            "bible_ready": "کتاب مقدس برای استفاده آفلاین آماده است",
            "book_ready": "٪ آماده استفاده آفلاین است",
            "download_bible": "کتاب مقدس را برای استفاده آفلاین بارگیری کنید",
            "download_book": "بارگیری٪ برای استفاده آفلاین",
            "downloading": "در حال بارگیری",
            "downloading_chapter": "بارگیری فصل",
            "link_to_app": ": در اینجا پیوند به برنامه خلاقیت های جدید آمده است",
        ...
        {   "iso": "ur",
            "available_offline": "آف لائن استعمال کے لیے دستیاب ہے۔",
            "bible": "بائبل",
            "bible_downloaded": "بائبل ڈاؤن لوڈڈ",
            "bible_ready": "آف لائن استعمال کے لیے بائبل تیار ہے۔",
            "book_ready": "٪ آف لائن استعمال کے لیے تیار ہے۔",
            "download_bible": "آف لائن استعمال کے لیے بائبل ڈاؤن لوڈ کریں۔",
            "download_book": "آف لائن استعمال کے لیے٪ ڈاؤن لوڈ کریں۔",
            "downloading": "ڈاؤن لوڈ ہو رہا ہے۔",
            "downloading_chapter": "باب ڈاؤن لوڈ ہو رہا ہے ۔",
            "link_to_app": "نئی تخلیقات ایپ کا لنک یہ ہے:",
            "finished_download": "ڈاؤن لوڈ مکمل ہو گیا۔",
            "remove_item": "مقامی اسٹوریج سے٪ کو ہٹا دیں۔",
